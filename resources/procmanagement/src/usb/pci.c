 ...
 */
static inline void set_configuration_address(int bus, int slot, int func,
					     int offset)
{
	uint32_t address;
...
#define pci_read_dev_reg(x, in)                                                \
	...
	{                                                                      \
		set_configuration_address(dev->bus, dev->slot, dev->func,      \
					  offset);                             \
...
#define pci_write_dev_reg(x, out)                                              \
	void pci_write_dev_reg##x(struct pci_dev *dev, uint32_t offset,        \
				  uint##x##_t data)                            \
	{                                                                      \
		set_configuration_address(dev->bus, dev->slot, dev->func,      \
					  offset);                             \
